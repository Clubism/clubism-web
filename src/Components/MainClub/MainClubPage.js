...
const MainClubCategories = [
  ...
  { id: 2, value: 'social', title: '사회교양분과', itemId: '/mainClub/social' , subNav: []},
  { id: 3, value: 'art', title: '언행예술분과' , itemId: '/mainClub/art', subNav: []},
  { id: 4, value: 'religion', title: '종교분과' , itemId: '/mainClub/religion', subNav: []},
  { id: 5, value: 'pe', title: '체육분과', itemId: '/mainClub/pe' , subNav: []},
  { id: 6, value: 'academic', title: '학술분과', itemId: '/mainClub/academic' , subNav: []}
];
